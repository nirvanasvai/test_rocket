...
var content = __webpack_require__(/*! !../../../css-loader/dist/cjs.js??ref--6-1!../../../postcss-loader/src??ref--6-2!./jquery.fancybox.min.css */ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.min.css");
...
/***/ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.min.css":
/*!*******************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--6-1!./node_modules/postcss-loader/src??ref--6-2!./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.min.css ***!
  \*******************************************************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/jquery-bar-rating/dist/themes/fontawesome-stars.css":
/*!**********************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--6-1!./node_modules/postcss-loader/src??ref--6-2!./node_modules/jquery-bar-rating/dist/themes/fontawesome-stars.css ***!
  \**********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var content = __webpack_require__(/*! !../../../css-loader/dist/cjs.js??ref--6-1!../../../postcss-loader/src??ref--6-2!./fontawesome-stars.css */ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/jquery-bar-rating/dist/themes/fontawesome-stars.css");
...
$(document).ready(function () {
  var url = $(location).attr('pathname').substring($(location).attr('pathname').lastIndexOf('/') + 1);
  var productLink = $(location).attr('pathname');
  $('.change_form :input').change(function () {
    var filtersArr = [];
    var brandArr = [];
    var colorArr = []; // let minPrice = 0;
    // let maxPrice = 0;
    ...
    $.ajax({
      ...
      data: {
        ...
        brand: brandArr,
        color: colorArr // min: minPrice, max: maxPrice
  ...
  function dataProduct(productData) {
    ...
    productData.forEach(function (product) {
      productHtml += "\n            <div class=\"col-xl-3 col-lg-4 col-6\">\n                <div class=\"product_card\">\n                    <a href=\"".concat('/product/' + product.product_url, "\">\n                        <div class=\"product_img_title\">\n                            <div class=\"product_img\">\n                                <img class=\"main_img\" src=\"").concat(product.children_img.length ? '/storage/test/' + product.children_img[0].product_img : '/dist/images/no_image.jpg', "\" alt=\"").concat(product.name, "\">\n                                <span class=\"like\">\n                                    <i class=\"far fa-heart like_icon\" id=\"").concat(product.id, "\"></i>\n                                </span>\n                                <span class=\"percent\">\n                                    ").concat(product.sale !== null ? '<img src="/dist/images/percent.svg" alt="">' : '<span></span>', "\n                                </span>\n                            </div>\n                            <div class=\"product_title\">\n                                <p>").concat(product.name, "</p>\n                            </div>\n                        </div>\n                        <div class=\"product_info\">\n                            <p><span class=\"silver_text\">\u0410\u0440\u0442\u0438\u043A\u0443\u043B:&nbsp; </span>").concat(product.article, "</p>\n                            <p><span class=\"silver_text\">\u0411\u0440\u0435\u043D\u0434:&nbsp; </span>").concat(product.brands[0].brand_name, "</p>\n                        </div>\n                        <div class=\"price\">\n                            ").concat(product.price !== null ? '<div class="price"><p>Цена: <span class="red_text">' + product.price + '<img src="/dist/images/tg.svg" alt=""></span></div>' : '<span></span>', "\n                        </div>\n                    </a>\n                </div>\n            </div>");
    });
    $('.product_content').html(productHtml);
    var imgWidth = $('.main_img');
    imgWidth.css({
      'height': "".concat(imgWidth.width()),
      'opacity': '1',
      'max-height': 'none'
    });
  }
  ...
  function searchData(date) {
    var searchHtml = "";
    console.log(date);
    date.forEach(function (product) {
      searchHtml += "\n                        <a href=\"".concat('/product/' + product.product_link, "\">").concat(product.product_name, "</a>");
    });
  ...
  $(document).on('click', '.like_icon', function (e) {
    ...
    } else if (favoritesArr.find(function (item) {
      return item == id;
    })) {
      favoritesArr.forEach(function (item, index) {
        if (item == id) {
  ...
  if (JSON.parse(localStorage.getItem('favorite')) && JSON.parse(localStorage.getItem('favorite')).length) {
    ...
    $('.favorites_count').css('display', 'flex');
    $('.favorites_link i').css('color', '#646464');
    JSON.parse(localStorage.getItem('favorite')).forEach(function (i) {
      var localStorageItem = JSON.parse(i);
      $('.like_icon').each(function (item, i) {
  ...
  if (url === 'favorites') {
    var dataFavoriteArr = JSON.parse(localStorage.getItem('favorite'));
    $.ajax({
      method: "POST",
      url: "/api-favorites",
      data: {
      ...
      success: function success(response) {
        ...
        parse.forEach(function (item) {
          productHtml += "\n                        <div class=\"col-xl-3 col-lg-4 col-6 col-md-4\">\n                        <div class=\"product_card\">\n                            <a href=\"".concat('/product/' + item.product_url, "\">\n                                <div class=\"product_img_title\">\n                                    <div class=\"product_img\">\n                                        <img class=\"main_img\" src=\"").concat(item.children_img.length ? '/storage/test/' + item.children_img[0].product_img : '/dist/images/no_image.jpg', "\" alt=\"").concat(item.name, "\">\n                                        <span class=\"like\" >\n                                            <i class=\"far fa-heart like_icon fas\" id=\"").concat(item.id, "\"></i>\n                                        </span>\n                                        <span class=\"percent\">\n                                            ").concat(item.sale !== null ? '<img src="/dist/images/percent.svg" alt="">' : '<span></span>', "\n                                        </span>\n                                    </div>\n                                    <div class=\"product_title\">\n                                    <p>").concat(item.name, "</p>\n                                    </div>\n                                </div>\n                                <div class=\"product_info\">\n                                    <p><span class=\"silver_text\">\u0410\u0440\u0442\u0438\u043A\u0443\u043B: </span>").concat(item.article, "</p>\n                                    <p><span class=\"silver_text\">\u0411\u0440\u0435\u043D\u0434: </span>").concat(item.brands[0].brand_name, "</p>\n                                </div>\n                                ").concat(item.price !== null ? '<div class="price"><p>Цена: <span class="red_text">' + item.price + '<img src="/dist/images/tg.svg" alt=""></span></div>' : '<span></span>', "\n                            </a>\n                        </div>\n                    </div>");
        });
  ...
  $('.phone').blur(function () {
    var numberArr = [700, 701, 702, 703, 704, 705, 706, 707, 708, 709, 747, 750, 751, 760, 761, 762, 763, 764, 771, 775, 776, 777, 778];
    var phoneNum = parseInt($(this).val().substr(2, 3));
    var numLength = $(this).val().replace(/[^0-9]/gi, '');
  ...
  if ($("div").is(".catalog_innder_page")) {
    var productId = $('.product_info_main').attr('data-id');
    $.ajax({
      method: "POST",
      url: "/rating_count",
      data: {
      ...
      success: function success(response) {
        var ratingCount = parseInt(response);
  ...
  $('#requestCallFormButton').click(function (e) {
    e.preventDefault();
    var typeOrder = $(this).attr('data-type');
    $('.error_text').html('');
    $('#email').html("");
    var form = $('#requestCallForm').serializeArray();
    form.push({
      name: 'product_id',
      value: $('.product_info_main').data('id')
    });
    form.push({
      name: '_token',
    ...
    if (phoneCheck && emailCheck && name && capcha3) {
      $.ajax({
        ...
        error: function (_error2) {
          ...
          var errorCapcha = errors.responseJSON.errors;
          var errorText = JSON.parse(errors.responseText);
  ...
  $('#requestCallTopButton').click(function (e) {
    ...
    $('.error_text').html('');
    $('#email').html("");
    var form = $('#requestTopCallForm').serializeArray();
    form.push({
      name: '_token',
      value: $('meta[name="csrf-token"]').attr('content')
    });
  ...
  $('#send_review').click(function (e) {
    e.preventDefault();
    $('.error_text').html('');
    var form = $('#requestReviewForm').serializeArray();
    form.push({
      name: 'id_product',
      value: $('.product_info_main').data('id')
    });
  ...
  $('#send_review_tab').click(function (e) {
    e.preventDefault();
    $('.error_text').html('');
    var form = $('#requestReviewFormTab').serializeArray();
    form.push({
      name: 'id_product',
      value: $('.product_info_main').data('id')
    });
  ...
  $('.save_product').click(function (e) {
    ...
    } else if (youWatchedArr.find(function (item) {
      return item == id;
    })) {
      localStorage.setItem('watch', JSON.stringify(youWatchedArr));
    } else {
  ...
  if (JSON.parse(localStorage.getItem('watch')) !== null) {
    var localWatch = JSON.parse(localStorage.getItem('watch'));
    var productid = $('.like_icon').attr('id');
    var prouductArr = localWatch.filter(function (item) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        var parse = JSON.parse(response);
        var start = parse.length - 5;
        var end = parse.length;
        var watchEl = parse.slice(start, end);
        var productHtml = "";

        if (parse.length < 5) {
          parse.forEach(function (item, index) {
            productHtml += "\n                            <div class=\"col-xl-3 col-lg-3 col-6 col-md-4\">\n                            <div class=\"product_card\">\n                                <a href=\"".concat('/product/' + item.product_url, "\">\n                                    <div class=\"product_img_title\">\n                                        <div class=\"product_img\">\n                                            <img class=\"img_watch\" src=\"").concat(item.children_img.length ? '/storage/test/' + item.children_img[0].product_img : '/dist/images/no_image.jpg', "\" alt=\"\">\n                                            <span class=\"like\" >\n                                                <i class=\"far fa-heart like_icon\" id=\"").concat(item.id, "\"></i>\n                                            </span>\n                                            <span class=\"percent\">\n                                                ").concat(item.sale !== null ? '<img src="/dist/images/percent.svg" alt="">' : '<span></span>', "\n                                            </span>\n                                        </div>\n                                        <div class=\"product_title\">\n                                        <p>").concat(item.name, "</p>\n                                        </div>\n                                    </div>\n                                    <div class=\"product_info\">\n                                        <p><span class=\"silver_text\">\u0410\u0440\u0442\u0438\u043A\u0443\u043B: </span>").concat(item.article, "</p>\n                                        <p><span class=\"silver_text\">\u0411\u0440\u0435\u043D\u0434: </span>").concat(item.brands[0].brand_name, "</p>\n                                    </div>\n                                    ").concat(item.price !== null ? '<div class="price"><p>Цена: <span class="red_text">' + item.price + '<img src="/dist/images/tg.svg" alt=""></span></div>' : '<span></span>', "\n                                </a>\n                            </div>\n                        </div>");
          });
        } else {
          watchEl.forEach(function (item, index) {
            productHtml += "\n                            <div class=\"col-xl-3 col-lg-3 col-6 col-md-4\">\n                            <div class=\"product_card\">\n                                <a href=\"".concat('/product/' + item.product_url, "\">\n                                    <div class=\"product_img_title\">\n                                        <div class=\"product_img\">\n                                            <img class=\"img_watch\" src=\"").concat(item.children_img.length ? '/storage/test/' + item.children_img[0].product_img : '/dist/images/no_image.jpg', "\" alt=\"\">\n                                            <span class=\"like\" >\n                                                <i class=\"far fa-heart like_icon\" id=\"").concat(item.id, "\"></i>\n                                            </span>\n                                            <span class=\"percent\">\n                                                ").concat(item.sale !== null ? '<img src="/dist/images/percent.svg" alt="">' : '<span></span>', "\n                                            </span>\n                                        </div>\n                                        <div class=\"product_title\">\n                                        <p>").concat(item.name, "</p>\n                                        </div>\n                                    </div>\n                                    <div class=\"product_info\">\n                                        <p><span class=\"silver_text\">\u0410\u0440\u0442\u0438\u043A\u0443\u043B: </span>").concat(item.article, "</p>\n                                        <p><span class=\"silver_text\">\u0411\u0440\u0435\u043D\u0434: </span>").concat(item.brands[0].brand_name, "</p>\n                                    </div>\n                                    ").concat(item.price !== null ? '<div class="price"><p>Цена: <span class="red_text">' + item.price + '<img src="/dist/images/tg.svg" alt=""></span></div>' : '<span></span>', "\n                                </a>\n                            </div>\n                        </div>");
          });
        }

        $('.product_watch').html(productHtml);
        var imgWidth = $('.img_watch');
        imgWidth.css({
          'height': "".concat(imgWidth.width()),
          'opacity': '1',
          'max-height': 'none'
...
__webpack_require__(/*! jquery-bar-rating/dist/jquery.barrating.min.js */ "./node_modules/jquery-bar-rating/dist/jquery.barrating.min.js");

__webpack_require__(/*! jquery-bar-rating/dist/themes/fontawesome-stars.css */ "./node_modules/jquery-bar-rating/dist/themes/fontawesome-stars.css");
...
$(document).ready(function () {
  var _settings, _settings2, _settings3;
  ...
  $('.slider-for').slick({
    ...
    responsive: [{
      ...
      settings: (_settings = {
        ...
        asNavFor: false,
        fade: false
      }, _defineProperty(_settings, "centerMode", true), _defineProperty(_settings, "focusOnSelect", true), _settings)
    }, {
      breakpoint: 768,
      settings: (_settings2 = {
        slidesToShow: 1,
        ...
        asNavFor: false,
        fade: false
      }, _defineProperty(_settings2, "centerMode", true), _defineProperty(_settings2, "focusOnSelect", true), _settings2)
    }]
  });
  $('.slider-nav').slick({
    slidesToShow: 5,
  ...
  $('.product_info_slider').slick({
    ...
    responsive: [{
      ...
      settings: (_settings3 = {
        ...
        asNavFor: false,
        fade: false
      }, _defineProperty(_settings3, "centerMode", true), _defineProperty(_settings3, "focusOnSelect", true), _settings3)
    }]
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _catalog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./catalog */ "./resources/js/catalog.js");
...
$(document).ready(function () {
  ...
  var imgWidth = $('.main_img, .card_category img');
  imgWidth.css({
    'height': "".concat(imgWidth.width()),
    'opacity': '1',
    'max-height': 'none'
  ...
  var size = 35;
  var text = $('.product_title p');
  text.each(function () {
    if ($(this).text().length > size) {
      $(this).text($(this).text().slice(0, size) + '...');
    }
  });
  var sizeCategoryText = 150;
  var textCategory = $('.card_category_text p');
  ...
  $(document).mouseup(function (e) {
    ...
    if (!searchContentMobile.is(e.target) && searchContentMobile.has(e.target).length === 0) {
      $('.mobile_search').removeClass('mobile_search_active');
    }
  });
  ...
  $('.map').css('height', "".concat($('.map').width()));
  $('.map_footer').css('height', "".concat($('.map_footer').width()));
});
...
__webpack_require__(/*! C:\OpenServer\domains\timberstone\resources\js\index.js */"./resources/js/index.js");
module.exports = __webpack_require__(/*! C:\OpenServer\domains\timberstone\resources\sass\app.scss */"./resources/sass/app.scss");
